...
export const handler = async (event) => {
  ...
  //
  //   - care flags judge the last SEVEN LOGGED days, which one calendar day
  //     cannot hold, so on the 1d view they CANNOT FIRE. They are the one
  //     thing that outranks everything else in this product, and a screen
  //     where they are structurally silent is the worst version of this bug.
